...
10.times do |index|
	u = User.create(email: Faker::Internet.email , password: 'Bonjour' ,description:Faker::Dune.saying ,first_name: Faker::DragonBall.character , last_name: Faker::Zelda.character)
